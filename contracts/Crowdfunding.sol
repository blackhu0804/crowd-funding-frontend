...
contract Crowdfunding {
    ...
    modifier campaignOpen () {
        require(state == CampaignState.Active, "Campagin is not Active");
        _;
    }
    ...
    function fund(uint256 _tierIndex) public payable campaignOpen notPaused {
        require(block.timestamp < deadline, "Compagin has ended");
    ...
    function withdraw() public onlyOwner {
        checkAndUpdateCampaignState();
        require(state == CampaignState.Successful, "Campagin not successful");
    ...
    function refund() public {
        checkAndUpdateCampaignState();
        require(state == CampaignState.Failed, "Refunds not failed");
    ...
    function getCampaginStatus() public view returns(CampaignState) {
